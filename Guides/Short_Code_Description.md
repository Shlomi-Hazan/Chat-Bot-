...
- [`Main_Server.py`](https://github.com/Shlomi-Hazan/Chat-Bot-/blob/main/PartTwo/BotChat/Main_Server.py)
...
- [`Chat_UI.py`](https://github.com/Shlomi-Hazan/Chat-Bot-/blob/main/PartTwo/BotChat/Chat_UI.py) 
...
- [`Launcher_UI.py`](https://github.com/Shlomi-Hazan/Chat-Bot-/blob/main/PartTwo/BotChat/Launcher_UI.py) 
...
- [`Common_Setups.py`](https://github.com/Shlomi-Hazan/Chat-Bot-/blob/main/PartTwo/BotChat/Common_Setups.py) 

## UI_Router: 🌐
This script decides which screen to show based on the URL.
- [`UI_Router.py`](https://github.com/Shlomi-Hazan/Chat-Bot-/blob/main/PartTwo/BotChat/UI_Router.py)
...
- [`Run_App.py`](https://github.com/Shlomi-Hazan/Chat-Bot-/blob/main/PartTwo/BotChat/Run_App.py)
...
- [`State_Globals.py`](https://github.com/Shlomi-Hazan/Chat-Bot-/blob/main/PartTwo/BotChat/State_Globals.py) 
